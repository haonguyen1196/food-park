            ...
            <ul class="menu_icon d-flex flex-wrap">
                ...
                <li>
                    <a href="{{ route('dashboard', ['open' => 'message']) }}" class="  message_icon"><i
                            class="fas fa-comment-alt-dots"></i>
                        <span class="unseen-message" style="display: {{ $unseenMessage > 0 ? 'block' : 'none' }}">
            ...
            @foreach (Cart::content() as $cartItem)
                <li>
                    <div class="menu_cart_img">
                        <img src="{{ asset($cartItem->options['product_info']['image']) }}" alt="menu"
                    ...
                    <div class="menu_cart_text">
                        ...
                        @foreach ($cartItem->options['product_options'] as $optionItem)
                            <span class="extra">{{ $optionItem['name'] }}
                                {{ currencyPosition($optionItem['price']) }}</span>
                        @endforeach
